...
export default function AuctionWrite() {
  ...
  const handleTimeChange = (selectedTime: string) => {
    ...
    if (selectedTime >= currentTime) {
      ...
      setEndTime12(convertTo12HourFormat(selectedTime));
    } else {
      // You can optionally provide feedback to the user (e.g., show an error message)
      Swal.fire({
        text: "마감 시간은 현재 시간 이후의 시간만 선택 가능합니다.",
  ...
  return (
    <div className="max-w-screen-md mx-auto px-7">
      ...
      <PC>
        <h2 className="flex flex-col items-center justify-center text-4xl mt-28 font-bold p-10 pt-20">
          경매 등록
        </h2>
      </PC>
      <Mobile>
      ...
      <div className="mx-1 mt-4 flex flex-col">
        ...
        <div className="mb-4">
          ...
          <div className="flex flex-row">
            <p
              className="focus:outline-none py-[8px] border-b-[1px] text-[17px] bg-white cursor-pointer w-auto"
