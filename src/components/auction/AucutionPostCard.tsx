  ...
  return (
    <div>
      <PC>
          ...
          <Link href={`/auction/posts/${idx}`}>
            ...
            <div className="relative w-[233.59px] h-[233.59px] overflow-hidden hover:border-2 hover:border-main-color rounded-md">
              ...
              <img
                ...
                src={thumbnail !== null ? thumbnail : "/img/reptimate_logo.png"}
                width={233.59}
                height={233.59}
                alt={""}
                style={{ zIndex: 1 }}
            ...
            <div className="absolute bottom-0 left-0 mb-2 flex items-center z-20">
              <img
                ...
                height={10}
                src={
                  profilePath !== null ? profilePath : "/img/reptimate_logo.png"
                }
                alt={""}
              />
            ...
            <div
              ...
              } absolute right-3 flex items-center z-[999]`}
              style={{ top: 10, height: 18 }}
            >
              <p
        ...
        <div className="mb-6" style={{ marginLeft: 1, marginRight: 5 }}>
      ...
      <Mobile>
        <Link style={{ marginBottom: 16 }} href={`/auction/posts/${idx}`}>
          <div style={{}}>
            {/* 대표 이미지 부분 */}
